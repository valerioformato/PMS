...
- **[ ]** Pilot networking refactor: Connection hardening + async transport (Phase 1-2 done + 25 pilot tests covering single-flight cleanup; Phase 3-5 pending; Client.cpp compilation bug fixed)
